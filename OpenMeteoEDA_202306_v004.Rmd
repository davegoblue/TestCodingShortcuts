...
Example training data is created for all temperatures and dew points between -50 and 50 (rounded to the nearest 1), with RH calculated based on formula:  
```{r, fig.height=9, fig.width=9}
...
The weighted training data performs slightly better for data points with high density, at the offset of somewhat worse performance for less commonly observed relative humidities. Adding mtry=2 may address this:  
