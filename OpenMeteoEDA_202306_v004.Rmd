...
Core daily datasets are loaded, as well as processed hourly data for NYC:  
```{r cache=TRUE}
...
# Read hourly JSON file (NYC only)
nycOMTemp <- formatOpenMeteoJSON("testOM_hourly_nyc.json", addVars=TRUE)
