...
readRunUSAFacts <- function(maxDate, 
    ...
    # STEP 1: Get a county-level population file (convert to zero pad 5 for compatibility)
...
The data produced are broadly the same, with the exception of the misnamed counties (better in more recent) and elimination of zero population fips (better in previous).
