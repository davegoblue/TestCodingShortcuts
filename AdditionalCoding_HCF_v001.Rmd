...
set.seed(1711290801)
rndDraw <- sort(sample(1:52, size=7, replace=FALSE))
rndDraw

rndCards <- cardMatrix[rndDraw]
rndSuits <- 1 + (rndDraw - 1) %/% 13
rndCards
rndSuits

cardSuit1 <- rndCards[rndSuits == 1]
cardSuit2 <- rndCards[rndSuits == 2]
cardSuit3 <- rndCards[rndSuits == 3]
cardSuit4 <- rndCards[rndSuits == 4]
cardSuitNil <- rndCards[!(rndSuits %in% 1:4)]
