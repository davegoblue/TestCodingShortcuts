...
Next steps are to combine all of the precipitation functions, allow for output to be directed to a log file, and consolidate/save all processed EDA for later use.