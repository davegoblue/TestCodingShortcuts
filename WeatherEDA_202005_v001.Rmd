...
combinedPrecipitation <- function(df, 
    ...
    # Create the frame name to pass (deparse and substitute willjust return 'df' in the next function)
    frameName <- deparse(substitute(df))
    ...
    # Check for consistency    
    precipIntervals <- intervalConsistency(precipData, pType=pType)
