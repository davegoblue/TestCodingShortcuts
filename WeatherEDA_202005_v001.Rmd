...
New Orleans is interesting in that the final hours of the final day of the pulled METARare all raining.  This leads (correctly) to no final RAE in the METAR, and the logic should be updated to place an artificial RAE in the last minute of the file.  Without that, there is recycling, and the interval becomes -365 days.  There is a similar need to add logic in case the beginning state is RAB.
...
# Updateds function to account for:
