...
# DO NOT HAVE FILE ind_pop_data.csv ('CountryName,CountryCode,Year,Total Population,Urban population (% of total)\n)
...
# Initialize reader object: urb_pop_reader
urb_pop_reader = pd.read_csv("ind_pop_data.csv", chunksize=5000, encoding="latin-1")
