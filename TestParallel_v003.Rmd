...
The bootstrap and k-fold each took on the order of 4-5 minutes when run individually.  Next, we investigate the performance advantage of running in parallel with 2 clusters (which drove the overwhelming volume of the performance gains in the above timeWaster() simulations).  
```{r, cache=TRUE}
