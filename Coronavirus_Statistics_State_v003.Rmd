...
Evolution of state CFR is then run for select Great Lakes states:  
```{r}

# Deaths vs. cases in Great Lakes
assessStateCFR(mwCurveList_210106, 
               keyStates=c("IL", "IN", "MI", "OH"), 
               depVar="CTP_deaths", 
               indepVar="CTP_cases", 
               depTitleName="deaths", 
               indepTitleName="cases", 
...
CFR has similarly declined in select Great Lakes states, generally to the ~1.5% range.

Evolution of state CFR is then run for select Upper Midwest / Great Plains states:  
```{r}

# Deaths vs. cases in Upper Midwest / Great Plains
assessStateCFR(gpCurveList_210106, 
               keyStates=c("Dakotas", "IA", "MN", "WI"), 
               depVar="CTP_deaths", 
               indepVar="CTP_cases", 
               depTitleName="deaths", 
               indepTitleName="cases", 
...
Exploration of state CFR is then run for select southern states:  
```{r}

# Deaths vs. cases in select southern states
assessStateCFR(soCurveList_210106, 
               keyStates=c("AZ", "FL", "GA", "TX"), 
               depVar="CTP_deaths", 
               indepVar="CTP_cases", 
               depTitleName="deaths", 
...
Southern states had very little burden early, so the lag and CFR estimates are likely noise.  As the burden evolved, lag settled at around 25 days and with CFR of around 1.5%.  This is broadly consistent with other regions.

Lag between total hospitalized and death is also explored, starting with the northeast:  
```{r}

# Example for northeastern states
neHospDeathList_210106 <- createAndAlignCurves(stateData_210106, 
                                               yVal="vpm7", 
                                               namesPlot=c("CTP_hosp"),
                                               namesSec=c("CTP_deaths"), 
                                               keyStates=c("NY", "NJ", "MA", "CT", "RI", 
...
# Deaths vs. cases in northeastern states
neHospOut_210106 <- assessStateCFR(neHospDeathList_210106, 
                                   keyStates=c("DE/DC", "N NE", "NY/NJ", "S NE"), 
                                   depVar="CTP_deaths", 
                                   indepVar="CTP_hosp", 
                                   depTitleName="deaths", 
                                   indepTitleName="hospitalized", 
...
While total hospitalized is a stock and death is a flow, it appears the total number of people hospitalized is a reasonable leading indicator of deaths in the northeast, with roughly a 7-day lag and 2%-3% death "rate" by the end of 2020.

Lag between hospitalized and death is then assessed for select midwest states:  
```{r}

# Example for midwest states
mwHospDeathList_210106 <- createAndAlignCurves(stateData_210106, 
                                               yVal="vpm7", 
                                               namesPlot=c("CTP_hosp"),
                                               namesSec=c("CTP_deaths"), 
                                               keyStates=c("OH", "MI", "IN", "IL"),
...
# Deaths vs. cases in select midwest states
mwHospOut_210106 <- assessStateCFR(mwHospDeathList_210106, 
                                   keyStates=c("IL", "IN", "MI", "OH"), 
                                   depVar="CTP_deaths", 
                                   indepVar="CTP_hosp", 
                                   depTitleName="deaths", 
...
Midwest states seem to have a lag between total hospitalized and death rate in the ~10 day range, with roughly 2.5% of the hospitalized "stock" best correlated with the death rate ~10 days later.

Lag between hospitalized and death is then assessed for select upper midwest / plains states:  
```{r}

# Example for upper midwest / plains states
gpHospDeathList_210106 <- createAndAlignCurves(stateData_210106, 
                                               yVal="vpm7", 
                                               namesPlot=c("CTP_hosp"),
                                               namesSec=c("CTP_deaths"), 
                                               keyStates=c("WI", "MN", "ND", "SD", "IA"),
...
# Deaths vs. cases in select upper midwest / plains states
gpHospOut_210106 <- assessStateCFR(gpHospDeathList_210106, 
                                   keyStates=c("Dakotas", "IA", "MN", "WI"), 
                                   depVar="CTP_deaths", 
                                   indepVar="CTP_hosp", 
                                   depTitleName="deaths", 
...
Upper Midwest / Plains states seem to have a lag between total hospitalized and death rate in the ~10 day range, with roughly 4% of the hospitalized "stock" best correlated with the death rate ~10 days later.

Lag between hospitalized and death is then assessed for select southers states:  
```{r}

# Example for southern states
soHospDeathList_210106 <- createAndAlignCurves(stateData_210106, 
                                               yVal="vpm7", 
                                               namesPlot=c("CTP_hosp"),
                                               namesSec=c("CTP_deaths"), 
                                               keyStates=c("AZ", "FL", "GA", "LA", "TX"),
                                               plotTitle="2020 coronavirus burden per million per day", 
                                               plotSub="Hospitalized on main y-axis, deaths on secondary y-axis", 
                                               primYLab="Hospitalized per million (7-day rolling mean)",
                                               secYLab="Deaths per million (7-day rolling mean)",
...
# Deaths vs. cases in select southern states
# FL did not have hospital data prior to August; replace with LA
soHospOut_210106 <- assessStateCFR(soHospDeathList_210106, 
                                   keyStates=c("AZ", "GA", "LA", "TX"), 
                                   depVar="CTP_deaths", 
                                   indepVar="CTP_hosp", 
                                   depTitleName="deaths", 
                                   indepTitleName="hospitalized", 
...
Upper Midwest / Plains states seem to have a lag between total hospitalized and death rate in the 10-20 day range, with roughly 2.5% of the hospitalized "stock" best correlated with the death rate 10-20 days later.
