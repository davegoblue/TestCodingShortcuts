...
A function is written to integrate testData files from multiple regressions, categorize them, and plot the resulting RMSE:  
```{r}
...
The function is then run to compare the categorical-only forest and the categorical-plus-numerical forest:  
```{r}
