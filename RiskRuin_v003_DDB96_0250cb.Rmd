...
####_Conclusions_  
The results suggest that assuming a 2.5% loss rate, it is unlikely that actual results will ever fall more than 6k-10k units behind that benchmark.  The simulations match up reasonably well with the theory, suggesting that the "fake" cash back as solved by the polynomial is a plausible representation of the real world.  
