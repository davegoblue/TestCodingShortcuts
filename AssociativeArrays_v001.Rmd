...
updatedMismatch <- updatedFrame[updatedFrame$inDict==FALSE & updatedFrame$val>=60, c(2:1, 3)]
updatedMismatch

```

This refined pass matches ~45% of the unique words in Tom Sawyer (~75% of the words weighted by word usage), and misses fewer common words.  