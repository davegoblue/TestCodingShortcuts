...
# Add "poss." and "past" and "demons." and "1st" and "2nd" and "3rd" and "interrog." as search strings
regWords <- "[vn]\\.|ad[jv]\\.|prep\\.|pron\\.|conj\\.|poss\\.|past|demons\\.|1st|2nd|3rd|interrog\\."
...
# Print out all mismatches with 120+ usages
...
This refined pass matches ~45% of the unique words in Tom Sawyer (~75% of the words weighted by word usage), and misses fewer common words.  Again, the missing words are explored for whether something similar appears in the dictionary:  
```{r}
...
Perhaps there are still a few more improvements that can be made.  