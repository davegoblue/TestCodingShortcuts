...
Begin by populating the easiest arrays, array4 and array5.  Basically, this is just looping through each of the jbHands, keeping either 1 or 0 of the cards, and adding 1 to the appropriate column of array4 or array5:  
```{r}
...
The next step is to vectorize the above; run time is still FAR too long.  