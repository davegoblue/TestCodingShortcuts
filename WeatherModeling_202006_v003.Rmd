...
xgbRunModel_002 <- function(tbl, 
    ...
    valObjective <- c("reg:squarederror", "binary:logistic", "multi:softprob")
    if (!(xgbObjective %in% valObjective)) {
        cat("\nFunction is currently only prepared for:", valObjective, "\n")
...
Next steps are to continue with evaluating model predictions on test data (RMSE or confusion, confidence level) and to extend to predictions on other data sets.
