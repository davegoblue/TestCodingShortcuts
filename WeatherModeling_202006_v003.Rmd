...
There is roughly a 2% increase in classification accuracy, though the model now tends towards overconfidence in its predictions.  Next steps are to further assess the impact of eta and max_depth.