...
### Expansions week of 01-NOV-2021  
* Coronavirus_CDC_Daily_v003 additional arguments for makePeakValley()  
...
* Coronavirus_CDC_Daily_v003 integrated plots key metrics for a sample hospital  
...
* Coronavirus_CDC_Daily_v003 refreshed with latest hospital data  
* Coronavirus_CDC_Daily_v003 refreshed US hospital capacity summary  
  
### Expansions week of 21-FEB-2022  
* Coronavirus_CDC_Daily_v004 created  
* Coronavirus_CDC_Daily_v004 includes hospital data download function  
...
* Coronavirus_Statistics_USAF_v005 includes makeBurdenDatePlot()  
...
* Coronavirus_Statistics_USAF_v006 plots burden and vaccines for select counties  
* Coronavirus_Statistics_USAF_v006 compareBurdenVaxCounty() written  
...
### Expansions week of 06-JUN-2022  
...
* Coronavirus_Statistics_CDC_v006 function plotCDCRestatement() started  
...
### Expansions week of 08-AUG-2022  
* Coronavirus_CDC_Daily_v004 runs peakValleyCDCDaily()  
* Coronavirus_CDC_Daily_v004 runs hospitalCapacityCDCDaily()  
...
### Expansions week of 05-SEP-2022  
* Coronavirus_CDC_Daily_v004 runs peakValleyCDCDaily()  
* Coronavirus_CDC_Daily_v004 runs hospitalCapacityCDCDaily()  
...
* Coronavirus_Statistics_USAF_v007 created  
...
* Coronavirus_Statistics_USAF_v007 plots counties by reported case decline  
...
* Coronavirus_CDC_Daily_v005 tests comparison to previous data  
  
### Expansions week of 21-NOV-2022  
...
### Expansions week of 05-DEC-2022  
* Coronavirus_CDC_Daily_v005 runs postProcessCDCDaily()  
* Coronavirus_CDC_Daily_v005 runs peakValleyCDCDaily()  
* Coronavirus_CDC_Daily_v005 runs multiSourceDataCombine()  
* Coronavirus_CDC_Daily_v005 runs hospitalCapacityCDCDaily()  
* Coronavirus_Statistics_USAF_v007 checks memory usage  
* Coronavirus_Statistics_USAF_v007 cleanMem() written to manage RStudio objects  
* Coronavirus_Statistics_USAF_v007 updated with latest burden data  
  
### Expansions week of 12-DEC-2022  
* Coronavirus_Statistics_USAF_v007 updated with latest vaccines data  
* Coronavirus_Statistics_USAF_v007 runs postProcessCountyData()  
* Coronavirus_Statistics_USAF_v007 runs additionalCountyPostProcess()  
* Coronavirus_Statistics_CDC_v006 updated with latest data  
* Coronavirus_Statistics_CDC_v006 plotCDCRestatement() run  
* Coronavirus_CDC_Daily_v005 explores behavior of findPeaks()  
* Coronavirus_CDC_Daily_v005 explores alternate process for peak identification  
...
* Coronavirus_CDC_Daily_v005 downloads and processes latest hospital data  
* Coronavirus_CDC_Daily_v005 runs postProcessCDCDaily()  
* Coronavirus_CDC_Daily_v005 runs peakValleyCDCDaily() and updatedMakePeakValley()  
* Coronavirus_CDC_Daily_v005 runs multiSourceDataCombine()  
* Coronavirus_CDC_Daily_v005 runs hospitalCapacityCDCDaily()  
...
* InitialCardGameAnalysis_202301_v001 analyzes example hands of type 11 (0 wild)  
...
### Expansions week of 06-MAR-2023  
* Coronavirus_CDC_Daily_v005 runs peakValleyCDCDaily()  
* Coronavirus_CDC_Daily_v005 runs multiSourceDataCombine()  
* Coronavirus_CDC_Daily_v005 runs hospitalCapacityCDCDaily()  
...
* InitialCardGameAnalysis_202301_v001 explores evPlay for hands of type TTxxx (with wild)  
* InitialCardGameAnalysis_202301_v001 explores hands of type QQxxx (no wild)  
...
* InitialCardGameAnalysis_202301_v001 evaluates groups f and g of non-duplicated (suit) zero-wild hands  
...
* InitialCardGameAnalysis_202301_v001 handTypesByExclusion() updated for win/tie/loss  
...
* OpenMeteoEDA_202306_v001 function simpleOneVarApplyMapper() written
* OpenMeteoEDA_202306_v001 function simpleOneVarConfusionData() written  
...
* OpenMeteoEDA_202306_v001 plots lift of each predictor vs. night-day
* OpenMeteoEDA_202306_v001 plots lift of each predictor on season vs. night-day
* OpenMeteoEDA_202306_v001 runs simpleOneVarTrainTest() on each predictor vs. night-day-season
* OpenMeteoEDA_202306_v001 plots lift of each predictor vs. night-day-season
...
* OpenMeteoEDA_202306_v001 explores PCA and variance explained
...
* OpenMeteoEDA_202306_v001 explores combinations of top-4 variables in training data

### Expansions week of 11-SEP-2023  
* OpenMeteoEDA_202306_v001 explores random forest excluding top-4 variables for predicting year
* OpenMeteoEDA_202306_v001 explores random forest excluding top-4 variables for predicting month
* OpenMeteoEDA_202306_v001 explores random forest excluding top-4 variables for predicting month on holdout year
...
* TCP_202310_v001 explores ECDF of main bet final
...
* TCP_202310_v001 plots first time for hitting maximum by simulation
...
* OpenMeteoEDA_202306_v002 explores predicted vs. actual for daily mean and sd for deep soil temperature by month
* OpenMeteoEDA_202306_v002 further explores predicted vs. actual for daily mean and sd for deep soil moisture by month
...
* OpenMeteoEDA_202306_v002 R-squared on holdout for each continuous variable vs. hour of day
...
* OpenMeteoEDA_202306_v002 R-squared on holdout vs. OOB training for best variable vs. all three variables
* OpenMeteoEDA_202306_v002 runFullRF() run for each continuous variable vs. all variables other than self
...
* OpenMeteoEDA_202306_v002 plotConfusion() updated for auto-rounding
* OpenMeteoEDA_202306_v002 runFullRF() updated for auto-rounding
* OpenMeteoEDA_202306_v002 runPartialImportanceRF() updated for auto-rounding  
...
* OpenMeteoEDA_202306_v003 runPartialImportanceRF() run for month with varying number of predictors

### Expansions week of 12-FEB-2024  
...
* OpenMeteoEDA_202306_v003 explores deep soil temperature
...
* OpenMeteoEDA_202306_v003 runFullRF() run for day-night/season with 4 predictors
...
* OpenMeteoEDA_202306_v003 explores R2 for select combinations of 2 predictors on todSeason, using the full training subset
...
* OpenMeteoEDA_202306_v003 runFullRF() run for deep soil temperature for old city, without day-of-year and month
...
* OpenMeteoEDA_202306_v003 random forest model on original city temperature_2m predicts third city
...
* OpenMeteoEDA_202306_v003 explores accuracy for every combination of 2 predictors on city, using a smaller training subset with only the 2 most similar cities
* OpenMeteoEDA_202306_v003 explores accuracy for select combinations of 2 predictors on city, using the full training subset
...
* OpenMeteoEDA_202306_v004 runFullRF() to predict city based on numeric features
...
* OpenMeteoEDA_202306_v004 predicts VPD using f(T, D) with mtry=2
...
* OpenMeteoEDA_202306_v004 runs linear model using all predictors for snowfall
...
* OpenMeteoEDA_202306_v004 explores accuracy by precipitation type for predictions of weathercode using cloud cover, rain, and snow (mtry=3)
...
* OpenMeteoEDA_202306_v004 runs random forest model using only city, month, and day/night for ground level wind speed
...
* OpenMeteoEDA_202306_v004 runs select combinations of 2 predictors on ground wind speed, using the full training data
...
* OpenMeteoEDA_202306_v004 explores todSeason predictions using rpart excluding 'hour' and 'doy', but with 'src'
* OpenMeteoEDA_202306_v004 explores todSeason predictions using random forest

### Expansions week of 28-OCT-2024  
...
* OpenMeteoEDA_202306_v005 plots select continuous variables by year
* OpenMeteoEDA_202306_v005 plots select categorical variables by year
* OpenMeteoEDA_202306_v005 further explores wind direction by year
* OpenMeteoEDA_202306_v005 boxplot for windspeed by month
* OpenMeteoEDA_202306_v005 boxplot for precipitation by month

### Expansions week of 27-JAN-2025  
* OpenMeteoEDA_202306_v005 boxplot for temperature by month
* OpenMeteoEDA_202306_v005 ACF/PACF for temperature
* OpenMeteoEDA_202306_v005 ACF/PACF for precipitation
* OpenMeteoEDA_202306_v005 ACF/PACF for wind speed
...
* OpenMeteoEDA_202306_v005 explores cumulative percent of total precipitation by daily precipitation amount by decade
* OpenMeteoEDA_202306_v005 rolling 21-day means by metric and day of year, for three cities
...
### Expansions week of 17-MAR-2025  
* OpenMeteoEDA_202306_v005 boxplot for windspeed by month
* OpenMeteoEDA_202306_v005 boxplot for precipitation by month
* OpenMeteoEDA_202306_v005 boxplot for temperature by month
* OpenMeteoEDA_202306_v005 ACF/PACF for temperature
...
### Expansions week of 24-MAR-2025  
* OpenMeteoEDA_202306_v005 boxplot for daily wind speed change by month
* OpenMeteoEDA_202306_v005 boxplot for daily precipitation change by month
* OpenMeteoEDA_202306_v005 rolling 21-day means by metric and day of year
* OpenMeteoEDA_202306_v005 rolling 21-day standard deviation by metric and day of year
...
### Expansions week of 14-APR-2025  
* OpenMeteoEDA_202306_v005 boxplot for daily wind speed change by month
* OpenMeteoEDA_202306_v005 boxplot for daily precipitation change by month
* OpenMeteoEDA_202306_v005 rolling 21-day means by metric and day of year
* OpenMeteoEDA_202306_v005 rolling 21-day standard deviation by metric and day of year
...
### Expansions week of 28-APR-2025  
* OpenMeteoEDA_202306_v005 boxplot for precipitation by month
* OpenMeteoEDA_202306_v005 boxplot for temperature by month
* OpenMeteoEDA_202306_v005 ACF/PACF for temperature
* OpenMeteoEDA_202306_v005 ACF/PACF for precipitation
...
* OpenMeteoEDA_202306_v005 omCreateBoxPlot() with one-day lag run for a new city
...
* OpenMeteoEDA_202306_v005 calculates distance metric for dominant wind direction by month
...
* OpenMeteoEDA_202306_v005 calculates distance metric for daily WMO weather code by month-city
* OpenMeteoEDA_202306_v005 explores dominant WMO weather code for select city-month
...
* OpenMeteoEDA_202306_v005 runs random forest to predict city based on numeric variables
* OpenMeteoEDA_202306_v005 runs random forest to predict city based on numeric and factorial variables
* OpenMeteoEDA_202306_v005 runs random forest to predict maximum temperature based on numeric variables
...
* OpenMeteoEDA_202306_v005 predicts temperature for new data based on existing RF model
* OpenMeteoEDA_202306_v005 predicts temperature for new data based on existing RF model, modified to use most similar city

### Expansions week of 28-JUL-2025  
* OpenMeteoEDA_202306_v005 runs random forest to predict month based on numeric and factorial variables
* OpenMeteoEDA_202306_v005 runs random forest to predict month based on numeric and factorial variables, focused on 3 similar cities
...
### Expansions week of 04-AUG-2025  
* OpenMeteoEDA_202306_v005 runs random forest to predict city based on numeric and factorial variables
* OpenMeteoEDA_202306_v005 runs random forest to predict month based on numeric and factorial variables
* OpenMeteoEDA_202306_v005 runs random forest to predict temperature based on numeric and factorial variables
* OpenMeteoEDA_202306_v005 loads previously downloaded daily data for a new city
...
### Expansions week of 11-AUG-2025  
* OpenMeteoEDA_202306_v005 runs random forest to predict city based on numeric and factorial variables
* OpenMeteoEDA_202306_v005 runs random forest to predict month based on numeric and factorial variables
* OpenMeteoEDA_202306_v005 runs random forest to predict temperature based on numeric and factorial variables
* OpenMeteoEDA_202306_v005 loads previously downloaded daily data for a new city
...
* OpenMeteoEDA_202306_v006 runs ARIMA(0, 0, 1) for dewpoint by city
...
* OpenMeteoEDA_202306_v006 runs ARIMA(0, 0, 0) for daily dewpoint vs. long-term rolling 21-day mean dewpoint by day of year and city
* OpenMeteoEDA_202306_v006 runs ARIMA(1, 0, 0) for daily dewpoint vs. long-term rolling 21-day mean dewpoint by day of year and city
* OpenMeteoEDA_202306_v006 runs ARIMA(0, 0, 1) for daily dewpoint vs. long-term rolling 21-day mean dewpoint by day of year and city
* OpenMeteoEDA_202306_v006 runs ARIMA(1, 0, 1) for daily dewpoint vs. long-term rolling 21-day mean dewpoint by day of year and city
...
* OpenMeteoEDA_202306_v006 runs ARIMA(0, 0, 0) for daily temperature vs. long-term rolling 21-day mean temperature by day of year and city
* OpenMeteoEDA_202306_v006 plots current vs. next daily temperature vs. long-term rolling 21-day mean temperature by day of year and city
* OpenMeteoEDA_202306_v006 runs ARIMA(1, 0, 0) for daily temperature vs. long-term rolling 21-day mean temperature by day of year and city
* OpenMeteoEDA_202306_v006 runs ARIMA(0, 0, 1) for daily temperature vs. long-term rolling 21-day mean temperature by day of year and city
...
* OpenMeteoEDA_202306_v006 plots sigma-squared by model for daily temperature vs. long-term rolling 21-day mean temperature by day of year and city
...
* OpenMeteoEDA_202306_v006 runs ARIMA(2, 0, 0) for daily maximum wind speed vs. long-term rolling 21-day mean of maximum wind speed by day of year and city
* OpenMeteoEDA_202306_v006 compiles sigma-squared for ARIMA models for all cities

### Expansions week of 24-NOV-2025  
* OpenMeteoEDA_202306_v006 plots sigma-squared for ARIMA models for all cities
...
* OpenMeteoEDA_202306_v006 plots sigma-squared by model for daily maximum wind speed, baseline and vs. long-term rolling 21-day mean of maximum wind speed by day of year and city
...
* OpenMeteoEDA_202306_v006 runs ARIMA(1, 0, 0) for daily precipitation vs. long-term rolling 21-day mean of daily precipitation by day of year and city
* OpenMeteoEDA_202306_v006 runs ARIMA(0, 0, 1) for daily precipitation vs. long-term rolling 21-day mean of daily precipitation by day of year and city
* OpenMeteoEDA_202306_v006 runs ARIMA(1, 0, 1) for daily precipitation vs. long-term rolling 21-day mean of daily precipitation by day of year and city
* OpenMeteoEDA_202306_v006 runs ARIMA(2, 0, 0) for daily precipitation vs. long-term rolling 21-day mean of daily precipitation by day of year and city
* OpenMeteoEDA_202306_v006 compiles sigma-squared for ARIMA models for all cities
* OpenMeteoEDA_202306_v006 plots sigma-squared for ARIMA models for all cities
...
* OpenMeteoEDA_202306_v006 runs ARIMA(0, 0, 1) for daily shortwave radiationb vs. long-term rolling 21-day mean of daily shortwave radiation by day of year and city
* OpenMeteoEDA_202306_v006 runs ARIMA(1, 0, 1) for daily shortwave radiationb vs. long-term rolling 21-day mean of daily shortwave radiation by day of year and city
* OpenMeteoEDA_202306_v006 runs ARIMA(2, 0, 0) for daily shortwave radiationb vs. long-term rolling 21-day mean of daily shortwave radiation by day of year and city
* OpenMeteoEDA_202306_v006 compiles sigma-squared for ARIMA models for all cities
* OpenMeteoEDA_202306_v006 plots sigma-squared for ARIMA models for all cities
...
* OpenMeteoEDA_202306_v006 explores random forest to predict grouped cold vs. individual warm city  
...
* OpenMeteoEDA_202306_v006 explores season predictions for a lower accuracy city  
...
* OpenMeteoEDA_202306_v006 explores negative predictive power for a single city  
* OpenMeteoEDA_202306_v006 updates associated plots  
* OpenMeteoEDA_202306_v006 explores precision-recall for a single city  
* OpenMeteoEDA_202306_v006 explores precision-recall for all cities  
* OpenMeteoEDA_202306_v006 explores F1 score for all cities  
...
### Expansions week of 04-MAY-2026  
...
* OpenMeteoEDA_202306_v006 explores city-season by segment with cutree(k=4)  
* OpenMeteoEDA_202306_v006 explores city-season by segment with cutree(k=5)  
* OpenMeteoEDA_202306_v006 explores city-season by segment with cutree(k=6)  
...
### Expansions week of 08-JUN-2026  
...
* OpenMeteoEDA_202306_v006 corrects calculations and plots for assignKMeans(k=5)  
* OpenMeteoEDA_202306_v006 corrects calculations and plots for assignKMeans(k=6)  
...
* OpenMeteoEDA_202306_v006 explores percentiles by centroid (k=2)  
* OpenMeteoEDA_202306_v006 explores percentiles by centroid (k=3)  
...
* OpenMeteoEDA_202306_v006 explores cumulative precipitation by year for a second city  
* OpenMeteoEDA_202306_v006 explores percent of cumulative precipitation by year for a second city  
...
* OpenMeteoEDA_202306_v006 explores precipitation events and volumes by threshold for a single city  
...
### Expansions week of 27-JUL-2026  
* OpenMeteoEDA_202306_v006 explores degree days histogram for a third city by month  
* OpenMeteoEDA_202306_v006 explores degree days density histogram for a single city by month  
* OpenMeteoEDA_202306_v006 explores degree days density histogram for a second city by month  
* OpenMeteoEDA_202306_v006 explores degree days density histogram for a third city by month  
* OpenMeteoEDA_202306_v006 explores degree days density vs. overall for a single city by month  
...
* OpenMeteoEDA_202306_v006 explores cumulative net degree days by year for a third city  
* OpenMeteoEDA_202306_v006 explores cumulative net degree days by day of year for a single city  
...
### Expansions week of 17-AUG-2026  
...
* OpenMeteoEDA_202306_v006 plots hourly precipitation histogram for a third city  
* OpenMeteoEDA_202306_v006 plots hourly precipitation histogram for all cities  
* OpenMeteoEDA_202306_v006 plots maximum hourly precipitation by day histogram for a single city  

### Expansions week of 24-AUG-2026  
* OpenMeteoEDA_202306_v006 plots maximum hourly precipitation by day histogram for a second city  
* OpenMeteoEDA_202306_v006 plots maximum hourly precipitation by day histogram for a third city  
* OpenMeteoEDA_202306_v006 plots maximum hourly precipitation by day histogram for all cities  
...
* OpenMeteoEDA_202306_v006 plots maximum hourly precipitation by day histogram by month for a fourth city  
* OpenMeteoEDA_202306_v006 plots maximum hourly vs. daily total precipitation histogram for a single city  
* OpenMeteoEDA_202306_v006 plots maximum hourly vs. daily total precipitation histogram for a second city  
* OpenMeteoEDA_202306_v006 plots maximum hourly vs. daily total precipitation histogram for a third city  

### Expansions week of 07-SEP-2026  
...
* OpenMeteoEDA_202306_v006 updates boxplot for daily total vs. maximum hourly precipitation for all cities  

### Expansions week of 14-SEP-2026  
* OpenMeteoEDA_202306_v006 boxplot for daily hours vs. maximum hourly precipitation for a single city  
* OpenMeteoEDA_202306_v006 boxplot for daily hours vs. maximum hourly precipitation for a second city  
* OpenMeteoEDA_202306_v006 boxplot for daily hours vs. maximum hourly precipitation for a third city  
* OpenMeteoEDA_202306_v006 boxplot for daily hours vs. maximum hourly precipitation for all cities  
* OpenMeteoEDA_202306_v006 plots maximum hourly vs. total daily precipitation for a single city  
* OpenMeteoEDA_202306_v006 plots maximum hourly vs. total daily precipitation for a second city  
* OpenMeteoEDA_202306_v006 plots maximum hourly vs. total daily precipitation for a third city  
...
* OpenMeteoEDA_202306_v006 updates maximum hourly vs. total daily precipitation for a fourth city  
* OpenMeteoEDA_202306_v006 updates maximum hourly vs. total daily precipitation for a fifth city  
* OpenMeteoEDA_202306_v006 updates maximum hourly vs. total daily precipitation for all cities  
