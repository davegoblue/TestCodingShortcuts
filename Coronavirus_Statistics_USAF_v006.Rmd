...
vaxState_20220309 <- vaxFix65_20220309 %>%
...
# Use statePerCapita (created previously)
allState_20220309 <- statePerCapita %>%
    select(state, date, vxcpoppct, vxcgte18pct, vxcgte65pct) %>%
    filter(state %in% c(state.abb, "DC")) %>%
    right_join(vaxState_20220309, by=c("state", "date"))
allState_20220309
...
identical(integrateStateVaccine(vaxFix65_20220309, statePerCap=statePerCapita), allState_20220309)
