...
The process is updated with the latest data, with parameters updated for 2023:  
```{r, fig.height=9, fig.width=9, cache=TRUE}

# STEP 0: Appropriate parameters for 2023 data
cdcExcessParams <- list(remapVars=c('Jurisdiction'='fullState', 
                                    'Week Ending Date'='weekEnding', 
                                    'State Abbreviation'='state', 
                                    'Age Group'='age', 
                        ...
                        periodLevels=c("2015-2019", "2020", "2021", "2022", "2023"),
                        periodKeep=c("2015-2019", "2020", "2021"), # will need to update once 2022 data complete
                        yearLevels=2015:2023
                        )
...
cdcList_20230213 <- readRunCDCAllCause(loc=cdcLoc, 
                                       ...
                                       stateNoCheck=c(), 
                                       cvDeathThru="2022-11-19", # due to misalignment of years in Q1
                                       pdfCluster=TRUE, 
                                       pdfAge=TRUE
                                       )
...
# Plot for all ages
plotCDCRestatement(lstOld="cdcList_arch_2022w17", 
                   lstNew="cdcList_20230213", 
                   lstLabels=c("deaths_220425", "deaths_230213"), 
                   minDate="2021-12-01"
                   )
...
# STEP 1: Latest CDC all-cause deaths data
cdcLoc <- "Weekly_counts_of_deaths_by_jurisdiction_and_age_group_downloaded_20230309.csv"
cdcList_20230309 <- readRunCDCAllCause(loc=cdcLoc, 
                                       weekThru=49, 
                                       lst=readFromRDS("cdc_daily_230202"), 
                                       stateNoCheck=c(), 
                                       cvDeathThru="2022-12-10", # due to misalignment of years in Q1
                                       pdfCluster=TRUE, 
                                       pdfAge=TRUE
                                       )
saveToRDS(cdcList_20230309, ovrWriteError=FALSE)

# STEP 2: Latest death by location-cause data
allCause_230309 <- analyzeAllCause(loc="COvID_deaths_age_place_20230213.csv", 
                                   cdcDailyList=readFromRDS("cdc_daily_230302"), 
                                   compareThruDate="2023-02-28"
                                   )
saveToRDS(allCause_230309, ovrWriteError=FALSE)

# STEP 3: Facets for excess all-cause deaths
excessDeathFacets(lstCDC=cdcList_20230309, lstAll=allCause_230309, dateThru="2023-02-28", plotYLim=c(-200, 1200))
...
# Plot for all ages
plotCDCRestatement(lstOld="cdcList_arch_2022w17", 
                   lstNew="cdcList_20230309", 
                   lstLabels=c("deaths_220425", "deaths_230309"), 
                   minDate="2021-12-01"
                   )
...
# STEP 1: Latest CDC all-cause deaths data
cdcLoc <- "Weekly_counts_of_deaths_by_jurisdiction_and_age_group_downloaded_20230408.csv"
cdcList_20230408 <- readRunCDCAllCause(loc=cdcLoc, 
                                       weekThru=52, 
                                       lst=readFromRDS("cdc_daily_230402"), 
                                       stateNoCheck=c(), 
                                       cvDeathThru="2022-12-31", # due to misalignment of years in Q1
                                       pdfCluster=TRUE, 
                                       pdfAge=TRUE
                                       )
saveToRDS(cdcList_20230408, ovrWriteError=FALSE)

# STEP 2: Latest death by location-cause data
allCause_230408 <- analyzeAllCause(loc="COvID_deaths_age_place_20230408.csv", 
                                   cdcDailyList=readFromRDS("cdc_daily_230402"), 
                                   compareThruDate="2023-03-28"
                                   )
saveToRDS(allCause_230408, ovrWriteError=FALSE)

# STEP 3: Facets for excess all-cause deaths
excessDeathFacets(lstCDC=cdcList_20230408, lstAll=allCause_230408, dateThru="2023-03-28", plotYLim=c(-200, 1200))
...
# Plot for all ages
plotCDCRestatement(lstOld="cdcList_arch_2022w17", 
                   lstNew="cdcList_20230408", 
                   lstLabels=c("deaths_220425", "deaths_230408"), 
                   minDate="2021-12-01"
                   )
...
cdcExcessParams <- list(remapVars=c('Jurisdiction'='fullState', 
                        ...
                        periodLevels=c("2015-2019", "2020", "2021", "2022", "2023"),
                        periodKeep=c("2015-2019", "2020", "2021", "2022"), # Updated since 2022 data complete
                        yearLevels=2015:2023
                        )

# STEP 1: Latest CDC all-cause deaths data
cdcLoc <- "Weekly_counts_of_deaths_by_jurisdiction_and_age_group_downloaded_20230508.csv"
cdcList_20230508 <- readRunCDCAllCause(loc=cdcLoc, 
                                       weekThru=4, 
                                       lst=readFromRDS("cdc_daily_230502"), 
                                       stateNoCheck=c(), 
                                       cvDeathThru="2023-01-31", 
                                       pdfCluster=TRUE, 
                                       pdfAge=TRUE
                                       )
saveToRDS(cdcList_20230508, ovrWriteError=FALSE)

# STEP 2: Latest death by location-cause data
allCause_230508 <- analyzeAllCause(loc="COvID_deaths_age_place_20230508.csv", 
                                   cdcDailyList=readFromRDS("cdc_daily_230502"), 
                                   compareThruDate="2023-04-25"
                                   )
saveToRDS(allCause_230508, ovrWriteError=FALSE)

# STEP 3: Facets for excess all-cause deaths
excessDeathFacets(lstCDC=cdcList_20230508, lstAll=allCause_230508, dateThru="2023-04-25", plotYLim=c(-200, 1200))
...
# Plot for all ages
plotCDCRestatement(lstOld="cdcList_arch_2022w17", 
                   lstNew="cdcList_20230508", 
                   lstLabels=c("deaths_220425", "deaths_230508"), 
                   minDate="2021-12-01"
                   )
...
# STEP 1: Latest CDC all-cause deaths data
cdcLoc <- "Weekly_counts_of_deaths_by_jurisdiction_and_age_group_downloaded_20230608.csv"
cdcList_20230608 <- readRunCDCAllCause(loc=cdcLoc, 
                                       weekThru=9, 
                                       lst=readFromRDS("cdc_daily_230602"), 
                                       stateNoCheck=c(), 
                                       cvDeathThru="2023-03-07", 
                                       pdfCluster=TRUE, 
                                       pdfAge=TRUE
                                       )
saveToRDS(cdcList_20230608, ovrWriteError=FALSE)

# STEP 2: Latest death by location-cause data
allCause_230608 <- analyzeAllCause(loc="COvID_deaths_age_place_20230608.csv", 
                                   cdcDailyList=readFromRDS("cdc_daily_230602"), 
                                   compareThruDate="2023-05-10" # Data in CDC daily file ends here
                                   )
saveToRDS(allCause_230608, ovrWriteError=FALSE)

# STEP 3: Facets for excess all-cause deaths
excessDeathFacets(lstCDC=cdcList_20230608, lstAll=allCause_230608, dateThru="2023-05-10", plotYLim=c(-200, 1200))
...
# Plot for all ages
plotCDCRestatement(lstOld="cdcList_arch_2022w17", 
                   lstNew="cdcList_20230608", 
                   lstLabels=c("deaths_220425", "deaths_230608"), 
                   minDate="2021-12-01"
                   )
