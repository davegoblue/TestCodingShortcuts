...
# Plot of negative restatements in 2022
calculateRestatementFromRaw("cdcList_arch_2022w17", 
                            "cdcList_20220713", 
                            lstLabels=c("deaths_220425", "deaths_220713"), 
                            labelBase=TRUE
    ...
    mutate(pctNeg=deltaNeg/deaths_220425) %>%
    ggplot(aes(x=age, y=pctNeg)) + 
    geom_col(fill="lightblue") + 
    geom_text(aes(y=pctNeg/2, label=paste0(round(100*pctNeg, 1), "%"))) +
    coord_flip() +
    labs(title="Proportion of 2022 deaths in 2022-04-25 data not in 2022-07-13 data", y=NULL, x=NULL)
