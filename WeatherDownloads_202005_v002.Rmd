...
* Altimeter - remove 'A', convert remainder to numeric, and divide by 100 to get inches of mercury  
...
Some files have previously been processed and saved as RDS to "./RInputFiles/ProcessedMETAR/".  These are re-run to ensure that log files are created and that updates to Visibility and Altimeter are captured:  
...
The remaining files are also processed and saved:  
...
# Run the 2016-only versions - kdtw, kgrb, kgrr, kewr, kiah, kind, klnk, kmke, kmsn, kmsp
for (airport in c("kdtw", "kgrb", "kgrr", "kewr", "kiah", "kind", "klnk", "kmke", "kmsn", "kmsp")) {
...
# Run the 2015-2017 versions - klas, kmsy, kord, ksan
for (airport in c("klas", "kmsy", "kord", "ksan")) {
