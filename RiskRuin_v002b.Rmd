...
nTrials <- 240 ## Each trial is a column
nPerTrial <- 3000000 ## Each row will be a cumulative outcome
runParallel <- FALSE ## Should the following routines attempt to run in parallel?
