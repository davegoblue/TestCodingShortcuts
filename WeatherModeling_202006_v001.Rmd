...
Next, a sequential approach can be taken to see the gain in predictive ability as additional variables are added.  The data will again be the 2015-2017 data for the four climate archetypes:  
```{r}
