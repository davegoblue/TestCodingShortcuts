...
While there is no sharp elbow, there is some meaningful improvement out to 5 clusters.  The best silhouette width is at 2 or 3.  For curiosity, the model is run again for 5 clusters:  
```{r}
