...
Next steps are to update the function so that different time slices can be taken from each of the data sets (pick a fixed time period for one, allow a sliding scale for the other without inducing NA issues).