...
alignOutbreaks <- function(dfA, 
    ...
    for (lagLead in lagLeadTryB) {
        ...
        p1 <- useAll %>%
            ...
            labs(x="", y="Metric", title=paste0("Applying a lead/lag value of: ", lagLead))
        # Store the data in the list
        resultList[[ctr]] <- list(useAll=useAll, lagLead=lagLead, p1=p1)
...
The curves clearly align better and worse at different levels of lag/lead.  Next steps are to quantify the similarity and to include a best scalar at the level of highest similarity.