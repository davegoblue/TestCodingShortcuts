...
exploreStateAssociations <- function(lst, 
    ...
    p1 <- stateAssociationPlots(df, xVar=xVars[1], yVar=yVars[1], plotTime=plotLabel, printPlot=FALSE)
    p2 <- stateAssociationPlots(df, xVar=xVars[2], yVar=yVars[2], plotTime=plotLabel, printPlot=FALSE)
    p3 <- stateAssociationPlots(df, xVar=xVars[3], yVar=yVars[3], plotTime=plotLabel, printPlot=FALSE)
    p4 <- df %>% 
        mutate(cfr=dpm/cpm) %>% 
        stateAssociationPlots(xVar=xVars[4], yVar=yVars[4], plotTime=plotLabel, printPlot=FALSE)
