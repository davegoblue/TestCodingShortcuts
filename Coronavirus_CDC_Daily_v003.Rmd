...
exploreStateAssociations <- function(lst, 
    ...
    p1 <- stateAssociationPlots(df, xVar="cpm", yVar="dpm", plotTime=plotLabel, printPlot=FALSE)
    p2 <- stateAssociationPlots(df, xVar="vxcpoppct", yVar="cpm", plotTime=plotLabel, printPlot=FALSE)
    p3 <- stateAssociationPlots(df, xVar="vxcpoppct", yVar="dpm", plotTime=plotLabel, printPlot=FALSE)
    p4 <- df %>% 
        mutate(cfr=dpm/cpm) %>% 
        stateAssociationPlots(xVar="vxcpoppct", yVar="cfr", plotTime=plotLabel, printPlot=FALSE)
