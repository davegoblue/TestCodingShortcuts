...
There is some noise to the state-level data, but the approach is generally identifying the right peaks and valleys. Next steps are to add post-processing so that certain peaks and valleys (such as a repeating value) are filtered.