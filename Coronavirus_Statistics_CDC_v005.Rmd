...
deathAge_20210824_conv %>%
    select(-Year, -Month) %>%
    checkSubTotals(checkByVars=allCheckVars %>% setdiff("State"), 
                   subVar="State", 
                   subVarTotal="United States"
                   )

```

Next steps are to run comparisons of summed sub-totals and reported totals
