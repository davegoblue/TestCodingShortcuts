...
saveToRDS(cdcList_20210708, ovrWriteError=FALSE)
...
saveToRDS(cdcList_20210911, ovrWriteError=FALSE)
...
The cumulative death plots are also updated:  
```{r, fig.height=9, fig.width=9}

# Get the data and create the plot
deathAllList_20211205 <- deathTrends(cdcList_20211203, 
                                     lstCDCSub = allCause_211204,
                                     dateThru = "2021-10-31", 
                                     trendThru = "2019-12-31", 
                                     createPlot=FALSE
                                     )
makeCumulativeDeath(deathAllList_20211205)

# Alternate approach
deathTrends(cdcList_20211203, 
            lstCDCSub = allCause_211204,
            lstCDCFilter=list("age"=c("75-84 years", "85 years and older")), 
            lstCDCSubFilter=list("Age"=c("75-84 years", "85 years and over"), "State"="United States"),
            dateThru = "2021-10-31", 
...
The four facets by age group are also updated:  
```{r, fig.height=9, fig.width=9}

# Age 75+
p1 <- deathTrends(cdcList_20211203, 
                  lstCDCSub = allCause_211204,
                  lstCDCFilter=list("age"=c("75-84 years", "85 years and older")), 
                  lstCDCSubFilter=list("Age"=c("75-84 years", "85 years and over"), "State"="United States"),
                  dateThru = "2021-10-31", 
...
# Age 65-74
p2 <- deathTrends(cdcList_20211203, 
                  lstCDCSub = allCause_211204,
                  lstCDCFilter=list("age"=c("65-74 years")), 
                  lstCDCSubFilter=list("Age"=c("65-74 years"), "State"="United States"),
                  dateThru = "2021-10-31", 
...
# Age 0-64
p3 <- deathTrends(cdcList_20211203, 
                  lstCDCSub = allCause_211204,
                  lstCDCFilter=list("age"=c("45-64 years", "25-44 years", "Under 25 years")), 
                  lstCDCSubFilter=list("Age"=c("50-64 years", "40-49 years", "30-39 years", 
...
# All Ages
p4 <- deathTrends(cdcList_20211203, 
                  lstCDCSub = allCause_211204,
                  lstCDCFilter=list(), 
                  lstCDCSubFilter=list("Age"=c("All Ages"), "State"="United States"),
                  dateThru = "2021-10-31", 
...
The four facets by age group are converted to functional form:  
```{r, fig.height=9, fig.width=9}

deathTrendArgList <- list("p1"=list("cdcFilter"=list("age"=c("75-84 years", "85 years and older")), 
...
deathTrendGlobalList <- list("cdc"=cdcList_20211203, 
                             "cdcSub"=allCause_211204, 
                             "dateThru"="2021-10-31", 
                             "trendThru"="2019-12-31", 
                             "createPlot"=FALSE, 
...
deathTrendGrobs <- lapply(deathTrendArgList,
                          FUN=function(x) deathTrends(deathTrendGlobalList$cdc, 
                                                      lstCDCSub=deathTrendGlobalList$cdcSub,
                                                      lstCDCFilter=x[["cdcFilter"]], 
                                                      lstCDCSubFilter=x[["cdcSubFilter"]],
                                                      dateThru=deathTrendGlobalList$dateThru,
                                                      trendThru=deathTrendGlobalList$trendThru, 
                                                      createPlot=deathTrendGlobalList$createPlot
                                                      ) %>%
                              makeCumulativeDeath(plotSubtitle=x[["plotSubtitle"]], 
                                                  plotLegendPosition=deathTrendGlobalList$plotLegendPosition, 
                                                  plotYLim=deathTrendGlobalList$plotYLim, 
                                                  printPlot=deathTrendGlobalList$printPlot
                                                  )
                          )

gridExtra::grid.arrange(deathTrendGrobs$p4, 
                        deathTrendGrobs$p1, 
                        deathTrendGrobs$p2, 
                        deathTrendGrobs$p3, 
                        nrow=2
...
cdcLoc <- "Weekly_counts_of_deaths_by_jurisdiction_and_age_group_downloaded_20220105.csv"
cdcList_20220105 <- readRunCDCAllCause(loc=cdcLoc, 
                                       weekThru=49, 
                                       lst=readFromRDS("cdc_daily_211224"), 
                                       stateNoCheck=c("WV", "MD"), 
                                       pdfCluster=TRUE, 
                                       pdfAge=TRUE
                                       )
saveToRDS(cdcList_20220105, ovrWriteError=FALSE)
...
allCause_220106 <- analyzeAllCause(loc="COvID_deaths_age_place_20220106.csv", 
                                   cdcDailyList=readFromRDS("cdc_daily_220103"), 
                                   compareThruDate="2021-12-31"
                                   )
saveToRDS(allCause_220106, ovrWriteError=FALSE)
...
# Get the data and create the plot
deathAllList_20220107 <- deathTrends(cdcList_20220105, 
                                     lstCDCSub = allCause_220106,
                                     dateThru = "2021-11-30", 
                                     trendThru = "2019-12-31", 
                                     createPlot=FALSE
                                     )
makeCumulativeDeath(deathAllList_20220107)

# Alternate approach
deathTrends(cdcList_20220105, 
            lstCDCSub = allCause_220106,
            lstCDCFilter=list("age"=c("75-84 years", "85 years and older")), 
            lstCDCSubFilter=list("Age"=c("75-84 years", "85 years and over"), "State"="United States"),
            dateThru = "2021-11-30", 
...
The four facets by age group are updated:  
```{r, fig.height=9, fig.width=9}
...
deathTrendGlobalList <- list("cdc"=cdcList_20220105, 
                             "cdcSub"=allCause_220106, 
                             "dateThru"="2021-11-30", 
                             "trendThru"="2019-12-31", 
                             "createPlot"=FALSE, 
                             "plotLegendPosition"="bottom", 
...
The process is run for the latest 2022 data:  
```{r, fig.height=9, fig.width=9, cache=TRUE}
...
cdcLoc <- "Weekly_counts_of_deaths_by_jurisdiction_and_age_group_downloaded_20220618.csv"
cdcList_20220618 <- readRunCDCAllCause(loc=cdcLoc, 
                                       weekThru=21, 
...
saveToRDS(cdcList_20220618, ovrWriteError=FALSE)
...
allCause_220619 <- analyzeAllCause(loc="COvID_deaths_age_place_20220619.csv", 
                                   cdcDailyList=readFromRDS("cdc_daily_220602"), 
                                   compareThruDate="2022-05-31"
                                   )
saveToRDS(allCause_220619, ovrWriteError=FALSE)
...
# Get the data and create the plot
deathAllList_20220619 <- deathTrends(cdcList_20220618, 
                                     lstCDCSub = allCause_220619,
                                     dateThru = "2022-04-30", 
                                     trendThru = "2019-12-31", 
                                     createPlot=FALSE
                                     )
makeCumulativeDeath(deathAllList_20220619)

# Alternate approach - 75+
deathTrends(cdcList_20220618, 
            lstCDCSub = allCause_220619,
            lstCDCFilter=list("age"=c("75-84 years", "85 years and older")), 
            lstCDCSubFilter=list("Age"=c("75-84 years", "85 years and over"), "State"="United States"),
            dateThru = "2022-04-30", 
...
deathTrends(cdcList_20220618, 
    ...
    makeCumulativeDeath(plotSubtitle="Age 65-74")

# Alternate approach - Under 65
deathTrends(cdcList_20220618, 
            lstCDCSub = allCause_220619,
            lstCDCFilter=list("age"=c("45-64 years", "25-44 years", "Under 25 years")), 
            lstCDCSubFilter=list("Age"=c("0-17 years", "18-29 years", "30-39 years", "40-49 years", "50-64 years"), 
                                 "State"="United States"
                                 ),
            dateThru = "2022-04-30", 
            trendThru = "2019-12-31", 
    ...
    makeCumulativeDeath(plotSubtitle="Age Under 65")
...
deathTrendGlobalList <- list("cdc"=cdcList_20220618, 
                             "cdcSub"=allCause_220619, 
                             "dateThru"="2022-04-30", 
                             "trendThru"="2019-12-31", 
                             "createPlot"=FALSE, 
                             "plotLegendPosition"="bottom", 
...
excessDeathFacets(lstCDC=cdcList_20220618, lstAll=allCause_220619, dateThru="2022-04-30", plotYLim=c(-200, 1200))
