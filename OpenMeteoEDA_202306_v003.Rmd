...
dfImp <- map_dfr(list("month"=rfMonth, "temp"=rfTemp2m, "soil"=rfSoil255), 
...
Month is predicted using only the four top imortance variables:
```{r, fig.height=9, fig.width=9, cache=TRUE}
...
Prediction accuracy is decreased by ~10% as predictors are limited to 4
