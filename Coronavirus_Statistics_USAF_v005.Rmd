...
stateSimilarityScorePlot <- function(df, 
    ...
    # keyStates: states to plot
    # xText: x-location for text printing (y is at the top of the plot)
...
stateSimilarityScorePlot(similarityScore_20220309, keyStates=c("CA", "TX", "FL", "NY", "PA", "IL"))
