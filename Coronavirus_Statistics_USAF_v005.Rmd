...
Facetted plots can also be created:  
```{r, fig.height=9, fig.width=9}
...
Deaths data in particular requires further investigation for issues in GA, OK, KY, FL, NE, NJ, and potentially other areas.
