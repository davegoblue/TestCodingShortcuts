# This file contains functions for Coronavirus_Statistics_v002.Rmd
# 1.  Functions for working with COVID Tracking Project Data
# 2.  Functions for working with USA Facts data
# 3.  Functions for working with CDC all-cause deaths data
  

# ****** Functions for working with COVID Tracking Project Data ******
...
# ****** Functions for working with USA Facts Data ******
...
# ****** Functions for working with CDC Excess All-Cause Deaths Data ******
