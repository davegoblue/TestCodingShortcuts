...
readQCRawFile <- function(fileName, 
    ...
    # Step 0: Use urlType to infer key variables if passed as NULL
...
# Mapping file for aggregates for cdcHosp
keyAggMapper <- list("l1"=list("grpVar"="date", 
...
# Note that output data will include NA and has not yet mapped NYC and NY together
dfHosp <- readQCRawFile(fileName="./RInputFiles/Coronavirus/CDC_h_downloaded_210507.csv", 
                        urlType="cdcHosp",
                        getData=TRUE,
                        dfRef=dfHosp_old
                        )
...
Next steps are to update the process for assigning inputs to step 6 (compareAggregate and flagLaregDelta).
