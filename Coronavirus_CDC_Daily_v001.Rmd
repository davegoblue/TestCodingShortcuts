...
readQCRawFile <- function(fileName, 
    ...
    dfRaw %>%
        checkControl(groupBy=step3Group, useVars=step3Vals, printControls=FALSE) %>%
...
vecRename <- c('submission_date'='date', 'new_case'='new_cases', 
               'tot_death'='tot_deaths', 'new_death'='new_deaths'
               )

readQCRawFile(fileName="./RInputFiles/Coronavirus/CDC_dc_downloaded_210502.csv", 
              urlType="cdcDaily",
              getData=FALSE,
              dfRef=colRenamer(dfRaw_dc_210414, vecRename[2:length(vecRename)]),
              vecRename=vecRename, 
