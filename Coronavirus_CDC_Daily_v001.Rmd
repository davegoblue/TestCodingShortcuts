...
checkSimilarity <- function(df, 
    ...
    #          list('varName'=list(label='label', countOnly=boolean, externalLog=boolean))
    ...
    for (ctr in seq_along(keyVars)) {
        ...
        lstData <- keyVars[[ctr]]
        changeList[[ctr]] <- helperSimilarity(d1, 
                                              d2, 
                                              label=lstData$label, 
...
Next steps are to add a capability to plot the differences in the data elements.