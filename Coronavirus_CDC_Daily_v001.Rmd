...
createDetailedSummaries(dfDetail=dfFull, dfAgg=dfAgg, brewPalette="Paired")

```

Plots appear to be generated as expected.  Next steps are to add a plot reflecting recent growth of burden and to further parameterize the process.
