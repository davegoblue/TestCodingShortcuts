...
readRunCDCAllCause <- function(loc, 
    ...
    if (isTRUE(pdfCluster)) pdfCluster <- paste0(pdfStem, "cluster_", max(curYear), "w", zeroPad2(weekThru), ".pdf")
    if (isTRUE(pdfAge)) pdfAge <- paste0(pdfStem, "age_", max(curYear), "w", zeroPad2(weekThru), ".pdf")
...
* curYear=2021  
* startWeek=1  
* cvDeathThru inferred from weekThru and curYear  
  
The capability has been added to print detailed plots to PDF.

Next steps are to create a .R file for the functions and to source() that as part of the program.
