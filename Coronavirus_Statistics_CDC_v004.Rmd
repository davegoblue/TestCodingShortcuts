...
The process now reads and processes the file and runs diagnostics for sanity checks.  Next steps are to enable printing to an external log file and to integrate in to the main function.
