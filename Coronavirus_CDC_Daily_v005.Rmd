...
ggplot(data.frame(x=1:42, y=testVec, c=findPeaks(testVec, width=7)), 
       aes(x=x, y=y, color=c)
       ) + 
    geom_point() + 
...
Issues to address include 1) the midpoint always identified as a maximum, and 2) multiple tied values all identified as peaks
