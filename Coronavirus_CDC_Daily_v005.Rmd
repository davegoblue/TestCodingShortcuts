...
The function for processing downloaded data, without comparison to previous data, works as intended. Next steps are to update the appropriate mapping files to include "cdcWeeklyBurden" as an option, then check that the function runs as intended.
