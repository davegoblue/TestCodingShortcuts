...
# urlMapper$cdcWeeklyBurden <- "https://data.cdc.gov/api/views/9mfq-cb36/rows.csv?accessType=DOWNLOAD"
...
Next steps are to enable URL downloads and enable checking against a reference file