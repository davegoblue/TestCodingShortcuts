...
The function is run for all the vaccine variables:  
```{r, fig.height=9, fig.width=9}
...
The vaccines data also need to be converted for weekly rather than daily input beginning in June 2022