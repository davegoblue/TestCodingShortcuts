...
exploreReportedChange <- function(dfNew, 
    ...
    p1 <- testTable %>%
        ...
        geom_text(data=~filter(., timePeriod=="newer"), 
                  aes(label=round(useValue, ifelse(useValue > 1, 0, 3)), color=timePeriod), 
                  color="red", 
                  nudge_x=0.2
                  ) +
        ...
        coord_flip() + 
        labs(x=NULL, y=NULL, title="Metric summaries by data source", subtitle="Sum and percent of values NA") +
