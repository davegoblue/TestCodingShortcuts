...
ICU data seem consistent if the historical data are used to back-fill missing current data. Total beds data appears to have a sharp fall-off in both data sources around 2022-01, in addition to missing historical entries in the latest data
