...
integrateStateData <- function(stateData=NULL, 
    ...
    list(stateData=stateData, popData=popData, caseDeath=caseDeath, curveList=curveList)
...
fullStateList <- integrateStateData(ctpList=readFromRDS("test_old_201108"), 
                                    ...
                                    cdcList=readFromRDS("cdcList_20201110"), 
                                    runTwoAxis=FALSE,
                                    runCreateAlign=FALSE
                                    )
fullStateList

# Example for using the full stateData file
stateList <- integrateStateData(stateData=fullStateList$stateData, 
