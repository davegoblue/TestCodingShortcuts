...
At a glance, the rule-based approach creates reasonable county-level segments that are generally well differentiated as far as burden and shape.  Next stes are to continue to explore the county-level segmenting approach.
