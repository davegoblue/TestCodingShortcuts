...
Functions for reading and analyzing CDC all-cause deaths data include:  
```{r}
...
cdcAggregateSummary <- function(df, 
    ...
    # showPlots: boolean, whether to show a 1-page plot summary for each element of critSubsets
    ...
    for (ctr in seq_along(critSubsets)) {
        ...
        tmpList[[ctr]] <- cdcCohortAnalysis(cohortName=paste0("Iteration: ", ctr), 
                                            df=df, 
                                            critFilter=critUse, 
                                            plotTitle="",
                                            curYear=curYear,
                                            ...
                                            showPredActualPlots=showPlots,
                                            predActualPlotsOnePage=showPlots
                                            )
    }
    
    # Create the excess file
...
cdcAggregateSummary(df=cdc20200923, critVar="state", critSubsets=list(c("NY", "NJ"), c("FL", "GA")), startWeek=9, idVarName="cluster")
