...
Next steps are to further clean up the functions and plot labels so that the full process can be run with more recent data using fewer changes to the code.
