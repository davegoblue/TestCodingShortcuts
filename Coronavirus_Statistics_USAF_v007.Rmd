...
cty_postdata_20230108 <- postProcessCountyData(lstCtyBurden=cty_newdata_20230108$dfPerCapita, 
                                               lstCtyVax=cty_vaxdata_20230110$vaxFix, 
                                               lstState=readFromRDS("cdc_daily_230102")$dfPerCapita, 
                                               excludeStates="AK"
                                               )
...
# Step 1a: Burden comparisons for aggregated states
additionalCountyPostProcess(cty_postdata_20230108, p1CompareStates=c(state.abb, "DC"), p1AggData=TRUE)

# Step 1: Burden aggregation for key states
# Step 2: vaccine comparisons
# Step 3: Scoring updates (and errors)
# Step 4: New rolling data (28-day default with ceilings 50000 CPM, 500 DPM)
additionalCountyPostProcess(cty_postdata_20230108, 
                            p1CompareStates=c("GA", "FL", "NE", "IL", "OR"), 
                            p2VaxStates=c("MA", "HI", "VA", "VT", "GA", "RI", "NE"), 
                            p3VaxTimes=sort(c("2022-01-01", "2022-12-28")),
                            p4DF=cty_newdata_20230108$dfPerCapita, 
                            excludeStates=c("AK")
                            )
